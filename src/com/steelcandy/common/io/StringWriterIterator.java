...
/**
    The interface implemented by all iterators over StringWriter
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/common/io/StringWriterIterator.java
    </ul>

    @author James MacKay
    @see StringWriter
*/
public interface StringWriterIterator
{
    // Public methods
    ...
    */
    ...
    /**
        ...
        @return the next StringWriter without consuming it
