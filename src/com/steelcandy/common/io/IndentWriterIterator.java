...
/**
    The interface implemented by all iterators over IndentWriter
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/common/io/IndentWriterIterator.java
    </ul>

    @author James MacKay
    @see IndentWriter
*/
public interface IndentWriterIterator
{
    // Public methods
    ...
    */
    ...
    /**
        ...
        @return the next IndentWriter without consuming it
