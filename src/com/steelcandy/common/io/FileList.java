...
/**
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/common/io/FileList.java
    </ul>
    ...
    extends TypedList
{
    ...
    /**
        @return an empty list of File items that is backed
        by an array
    */
    public static FileList createArrayList()
    {
        return createArrayList(DEFAULT_CAPACITY);
    }

    /**
        Creates and returns an empty list of File items
        ...
        by an array
    */
    public static FileList createArrayList(int initialCapacity)
    {
        return new ArrayTypedList(initialCapacity);
    }

    /**
        @param c the FileList to copy
        @return a list containing the same items as 'c' in the same order,
        and that is backed by an array
    */
    public static FileList createArrayList(FileList c)
    {
        Assert.require(c != null);

        FileList result = createArrayList(c.size());
    ...
    /**
        ...
        by a linked list
    */
    public static FileList createLinkedList()
    {
    ...
    */
    public static FileList createLinkedList(FileList c)
    {
        Assert.require(c != null);

        FileList result = createLinkedList();
    ...
    /**
        @return an unmodifiable list of File items that
        contains the specified File as its sole element
    */
    public static FileList
        createSingleItemList(File item)
    {
        return new SingleItemTypedList(item);
    }

    /**
        @return an unmodifiable empty list of File items
    */
    public static FileList createEmptyList()
    {
        return EMPTY_LIST;
    }
    ...
    /**
        Constructs a(n) FileList with the specified
        initial capacity.

        @param initialCapacity the list's initial capacity
    */
    protected FileList(int initialCapacity)
    {
    ...
    */
    protected FileList(List backingList)
    {
        super(backingList);
    }
    ...
    /**
        @param arr an array of File items
        @return an iterator over all of the items in 'arr', in order
    */
    public static FileIterator iterator(File[] arr)
    {
        //Assert.ensure(result != null);
        return new FileArrayIterator(arr);
    }
    ...
    /**
        @return an iterator over all of the File items in
        this list, in order
    */
    public FileIterator iterator()
    {
        return new BuiltInFileListIterator(this);
    }

    /**
        @param item the File to look for
        @return true iff at least one File in this list
    ...
    */
    ...
    /**
        @param index the index in the list of the File
        to return
        @return the (index + 1)th File in this list
    ...
    */
    public int binarySearch(File item, Comparator c)
    {
        // 'item' can be null
        Assert.require(c != null);
    ...
    */
    public FileList
        filter(UnaryFilePredicate predicate)
    {
        Assert.require(predicate != null);

        FileList result =
            FileList.createArrayList(size());

        FileIterator iter = iterator();
        while (iter.hasNext())
        {
            File item = iter.next();
    ...
    /**
        Returns the index of the first File in this list
        that satisfies the specified predicate, or -1 if there is no such
        File in this list.

        @param predicate the predicate that an item in this list must satisfy
        in order for its index to be returned
        @return the index of the first File in this list
        that satisfies 'predicate'
    */
    public int indexOf(UnaryFilePredicate predicate)
    {
        Assert.require(predicate != null);
    ...
    /**
        ...
        predicate, or -1 if there is no such File in
        this list.
    ...
    */
    ...
    /**
        Returns the index of the last File in the list
        that satisfies the specified predicate, or -1 if there is no such
        File in this list.
        ...
        predicate
    */
    public int lastIndexOf(UnaryFilePredicate predicate)
    {
    ...
    /**
        ...
        predicate, or -1 if there is no such File
        in this list.
    ...
    */
    ...
    /**
        Adds the specified File to the end of this list.

        @param newItem the File to add to the end of
        this list
    */
    public void add(File newItem)
    {
        addObject(newItem);
    }

    /**
        Adds all of the File items in the specified list
        in order to the end of this list.

        @param list the list of File items to add to the
        end of this list
    */
    public void addAll(FileList list)
    {
        addAllObjects(list);
    }
    ...
    */
    ...
    /**
        Inserts the specified File into this list at the
        specified index.

        @param newItem the File to insert into this list
        @param index the index at which to insert the File
    */
    public void insert(File newItem, int index)
    {
        insertObject(newItem, index);
    }

    /**
        Inserts all of the File items in the specified
        list into this list in order, at the specified index.

        @param list the list of File items to insert into
        this list
        @param index the index at which to insert the File
        items
    */
    public void insertAll(FileList list, int index)
    {
    ...
    */
    public void set(int index, File newItem)
    {
    ...
    /**
        Removes from this list the first File in it
        that is equal to 'item', where items are compared using 'item''s
        equals() method.

        @param item the File to remove
    ...
    */
    public File[] toArray()
    {
        File[] array =
            new File[size()];
        return (File[]) toObjectArray(array);
    }
    ...
    */
    private static void appendItems(FileList src, FileList dest)
    {
        Assert.require(src != null);
        Assert.require(dest != null);

        FileIterator iter = src.iterator();
        while (iter.hasNext())
        {
            dest.add(iter.next());
        }
    ...
    */
    public abstract FileList cloneList();
        // Assert.ensure(result != null);
    ...
    */
    public abstract FileList subList(int startIndex);
        // Assert.ensure(result != null);
    ...
    */
        ...
        extends FileList
    {
        ...
        */
        ...
        /**
            @see FileList#cloneList
        */
        public FileList cloneList()
        {
            FileList result = new ArrayTypedList(size());
        ...
        /**
            @see FileList#subList(int)
        */
        public FileList subList(int startIndex)
        {
            return new ArrayTypedList(subBackingList(startIndex));
        }

        /**
            @see FileList#subList(int, int)
        */
        public FileList
            subList(int startIndex, int pastEndIndex)
        {
    ...
    /**
        An unmodifiable single-item list-backed FileList.
    */
        ...
        extends FileList
    {
        ...
        */
        public SingleItemTypedList(File item)
        {
        ...
        */
        public FileList cloneList()
        {
            FileList result = new SingleItemTypedList(get(0));
    ...
    */
        ...
        extends FileList
    {
        ...
        */
        public FileList cloneList()
        {
            FileList result = new LinkedTypedList();
    ...
    /**
        Iterates through the File items in a(n)
        FileList.

        @see File
        @see FileList
    */
    protected static class BuiltInFileListIterator
        ...
        implements FileIterator
    {
        ...
        /**
            Constructs a BuiltInFileListIterator from the
            FileList whose File items it is
            to iterate over.

            @param list the FileList that the
            iterator is to iterate over the elements of
        */
        public BuiltInFileListIterator(FileList list)
        {
            super(list);
        }
        ...
        /**
            @see FileIterator#next
        */
        public File next()
        {
            return (File) nextObject();
        }

        /**
            @see FileIterator#peek
        */
        public File peek()
        {
            return (File) peekObject();
        }
    }
}
    ...
    implements FileIterator
{
    ...
    */
    ...
    /**
        ...
        @param arr the array
    */
    public FileArrayIterator(File[] arr)
    {
