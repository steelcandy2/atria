...
/**
    The interface implemented by all iterators over Runnable
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/common/work/RunnableIterator.java
    </ul>
...
public interface RunnableIterator
{
    ...
    */
    ...
    /**
        ...
        @return the next Runnable without consuming it
