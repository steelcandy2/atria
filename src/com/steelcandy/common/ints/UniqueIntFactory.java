...
/**
    ...
    different from any of the other ints returned by the same factory since
    the later of
    <ul>
    ...
    implements IntFactory
{
    ...
    /**
        Indicates whether there is another int after the one that was last
        returned.
    */
        ...
        throws OutOfUniqueValuesException
    {
        if (_isNext == false)
        {
            String msg = _resources.
                getMessage(NO_UNIQUE_INT_LEFT_MSG);
