...
/**
    ...
    be non-negative and different from any of the other long ints returned by
    the same factory since the later of
    <ul>
    ...
    @author  James MacKay
*/
public class UniqueNonnegativeLongIntFactory
    implements LongIntFactory
{
    ...
    private static final String
        NO_UNIQUE_NONNEGATIVE_LONG_INT_LEFT_MSG =
            "NO_UNIQUE_NONNEGATIVE_LONG_INT_LEFT_MSG";
    ...
    /**
        Constructs a UniqueNonnegativeLongIntFactory.
    */
    public UniqueNonnegativeLongIntFactory()
    {
        reset();
    }
    ...
    */
    ...
    /**
        ...
        more unique non-negative long ints to return.
    ...
    */
    public long next()
    {
        if (_next < 0)
        {
            // It has wrapped around to the negatives.
            String msg = _resources.
                getMessage(NO_UNIQUE_NONNEGATIVE_LONG_INT_LEFT_MSG);
