...
/**
    ...
    created because an invalid output destination has been
    ...
    extends TestWriterCreationException
{
    ...
    /**
        Default constructor.
    */
    public InvalidOutputDestinationException()
    {
        // empty
    }
    ...
    */
    public InvalidOutputDestinationException(String msg)
    {
        super(msg);
    }
    ...
    */
    public InvalidOutputDestinationException(Throwable ex)
    {
        super(ex);
    }
    ...
    */
    public InvalidOutputDestinationException(String msg, Throwable ex)
    {
        super(msg, ex);
    }
}
