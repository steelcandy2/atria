...
/**
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/tokens/UnaryTokenListPredicate.java
    </ul>

    @author James MacKay
    @see TokenList
*/
public interface UnaryTokenListPredicate
{
    /**
        Indicates whether the specified TokenList satisfies this
        predicate.

        @param item the TokenList to test
        @return true iff the TokenList satisfies this predicate
    */
    public boolean isSatisfied(TokenList item);
}
