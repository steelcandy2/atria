...
/**
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/constructs/UnaryConstructPredicate.java
    </ul>

    @author James MacKay
    @see Construct
*/
public interface UnaryConstructPredicate
{
    /**
        Indicates whether the specified Construct satisfies this
        predicate.

        @param item the Construct to test
        @return true iff the Construct satisfies this predicate
    */
    public boolean isSatisfied(Construct item);
}
