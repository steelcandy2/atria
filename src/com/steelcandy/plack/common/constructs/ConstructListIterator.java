...
/**
    The interface implemented by all iterators over ConstructList
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/constructs/ConstructListIterator.java
    </ul>

    @author James MacKay
    @see ConstructList
*/
public interface ConstructListIterator
{
    // Public methods
    ...
    */
    ...
    /**
        ...
        @return the next ConstructList without consuming it
