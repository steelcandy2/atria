...
/**
    The interface implemented by all iterators over Construct
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/constructs/ConstructIterator.java
    </ul>

    @author James MacKay
    @see Construct
*/
public interface ConstructIterator
{
    // Public methods
    ...
    */
    ...
    /**
        ...
        @return the next Construct without consuming it
