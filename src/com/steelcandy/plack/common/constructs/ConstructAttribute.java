...
/**
    Represents a construct attribute whose value is of type Construct.
    ...
    extends Attribute
{
    ...
    /**
        Constructs a ConstructAttribute that has not been set yet.
    */
    ...
    /**
        Constructs a ConstructAttribute that has been set, and that has the
        specified value.

        @param value the attribute's value
    */
    public ConstructAttribute(Construct value)
    {
        super(value);
    ...
    /**
        ...
        a copy of
    */
    protected ConstructAttribute(ConstructAttribute a)
    {
    ...
    */
    public Construct value()
    {
        Assert.require(isSet());

        //Assert.ensure(result != null);
        return (Construct) valueObject();
    }
    ...
    */
    public void setValue(Construct newValue)
    {
    ...
    */
    public ConstructAttribute cloneAttribute()
    {
        // Assert.ensure(result != null);
        return new ConstructAttribute(this);
    }
}
