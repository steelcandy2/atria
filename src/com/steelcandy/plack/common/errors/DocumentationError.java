...
/**
    Represents an error found in the documentation located in the comments
    associated with a given construct.
    <p>
    ...
    extends AbstractPlackError
{
    ...
    /**
        Constructs a DocumentationError.
    ...
    */
    public DocumentationError(int level, String description,
