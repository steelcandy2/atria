...
/**
    The interface implemented by all iterators over SourceLocation
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/source/SourceLocationIterator.java
    </ul>

    @author James MacKay
    @see SourceLocation
*/
public interface SourceLocationIterator
{
    // Public methods
    ...
    */
    ...
    /**
        @return the next SourceLocation
    ...
    */
    ...
    /**
        ...
        @return the next SourceLocation without consuming it
