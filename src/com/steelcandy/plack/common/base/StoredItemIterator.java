...
/**
    The interface implemented by all iterators over StoredItem
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/base/StoredItemIterator.java
    </ul>

    @author James MacKay
    @see StoredItem
*/
public interface StoredItemIterator
{
    // Public methods
    ...
    */
    ...
    /**
        ...
        @return the next StoredItem without consuming it
