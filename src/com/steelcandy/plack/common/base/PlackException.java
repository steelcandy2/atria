    ...
    extends SteelCandyException
{
    ...
    */
    public PlackException(String msg)
    {
        super(msg);
    }
    ...
    /**
        ...
        an exception
    */
    public PlackException(Throwable ex)
    {
        super(ex);
    }
    ...
    /**
        ...
        @param ex the exception from which to construct a PlackException
    */
    public PlackException(String msg, Throwable ex)
    {
        super(msg, ex);
    }
}
