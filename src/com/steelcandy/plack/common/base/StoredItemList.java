...
/**
    Represents a list of StoredItem items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/base/StoredItemList.java
    </ul>

    @author James MacKay
    @see StoredItem
*/
public abstract class StoredItemList
    extends TypedList
{
    // Constants

    /** The default StoredItemList capacity. */
    protected static final int DEFAULT_CAPACITY = 15;

    /** The (unmodifiable) empty list. */
    private static final StoredItemList
    ...
    /**
        @return an empty list of StoredItem items that is backed
        by an array
    */
    public static StoredItemList createArrayList()
    {
        return createArrayList(DEFAULT_CAPACITY);
    }

    /**
        Creates and returns an empty list of StoredItem items
        ...
        by an array
    */
    public static StoredItemList createArrayList(int initialCapacity)
    {
        return new ArrayTypedList(initialCapacity);
    }

    /**
        @param c the StoredItemList to copy
        @return a list containing the same items as 'c' in the same order,
        and that is backed by an array
    */
    public static StoredItemList createArrayList(StoredItemList c)
    {
        Assert.require(c != null);

        StoredItemList result = createArrayList(c.size());
    ...
    /**
        ...
        by a linked list
    */
    public static StoredItemList createLinkedList()
    {
    ...
    */
    public static StoredItemList createLinkedList(StoredItemList c)
    {
        Assert.require(c != null);

        StoredItemList result = createLinkedList();
    ...
    /**
        @return an unmodifiable list of StoredItem items that
        contains the specified StoredItem as its sole element
    */
    public static StoredItemList
        createSingleItemList(StoredItem item)
    {
        return new SingleItemTypedList(item);
    }

    /**
        @return an unmodifiable empty list of StoredItem items
    */
    public static StoredItemList createEmptyList()
    {
        return EMPTY_LIST;
    }
    ...
    /**
        Constructs a(n) StoredItemList with the specified
        initial capacity.

        @param initialCapacity the list's initial capacity
    */
    protected StoredItemList(int initialCapacity)
    {
    ...
    */
    protected StoredItemList(List backingList)
    {
        super(backingList);
    }
    ...
    /**
        @param arr an array of StoredItem items
        @return an iterator over all of the items in 'arr', in order
    */
    public static StoredItemIterator iterator(StoredItem[] arr)
    {
        //Assert.ensure(result != null);
        return new StoredItemArrayIterator(arr);
    }
    ...
    /**
        @return an iterator over all of the StoredItem items in
        this list, in order
    */
    public StoredItemIterator iterator()
    {
        return new BuiltInStoredItemListIterator(this);
    }

    /**
        @param item the StoredItem to look for
        @return true iff at least one StoredItem in this list
    ...
    */
    ...
    /**
        @param index the index in the list of the StoredItem
        to return
        @return the (index + 1)th StoredItem in this list
    ...
    */
    ...
    {
        return (StoredItem) getObject(index);
    }
    ...
    */
    public StoredItem getLast()
        throws NoSuchItemException
    {
        return (StoredItem) getLastObject();
    }
    ...
    */
    public int binarySearch(StoredItem item, Comparator c)
    {
        // 'item' can be null
        Assert.require(c != null);
    ...
    */
    public StoredItemList
        filter(UnaryStoredItemPredicate predicate)
    {
        Assert.require(predicate != null);

        StoredItemList result =
            StoredItemList.createArrayList(size());

        StoredItemIterator iter = iterator();
        while (iter.hasNext())
        {
            StoredItem item = iter.next();
    ...
    /**
        Returns the index of the first StoredItem in this list
        that satisfies the specified predicate, or -1 if there is no such
        StoredItem in this list.

        @param predicate the predicate that an item in this list must satisfy
        in order for its index to be returned
        @return the index of the first StoredItem in this list
        that satisfies 'predicate'
    */
    public int indexOf(UnaryStoredItemPredicate predicate)
    {
        Assert.require(predicate != null);
    ...
    /**
        ...
        predicate, or -1 if there is no such StoredItem in
        this list.
    ...
    */
    ...
    /**
        Returns the index of the last StoredItem in the list
        that satisfies the specified predicate, or -1 if there is no such
        StoredItem in this list.
        ...
        predicate
    */
    public int lastIndexOf(UnaryStoredItemPredicate predicate)
    {
    ...
    /**
        ...
        predicate, or -1 if there is no such StoredItem
        in this list.
    ...
    */
    ...
    /**
        Adds the specified StoredItem to the end of this list.

        @param newItem the StoredItem to add to the end of
        this list
    */
    public void add(StoredItem newItem)
    {
        addObject(newItem);
    }

    /**
        Adds all of the StoredItem items in the specified list
        in order to the end of this list.

        @param list the list of StoredItem items to add to the
        end of this list
    */
    public void addAll(StoredItemList list)
    {
        addAllObjects(list);
    }
    ...
    */
    public void swap(int index1, int index2)
    {
        ...
        StoredItem tmp = get(index1);
        set(index1, get(index2));
        set(index2, tmp);
    }

    /**
        Inserts the specified StoredItem into this list at the
        specified index.

        @param newItem the StoredItem to insert into this list
        @param index the index at which to insert the StoredItem
    */
    public void insert(StoredItem newItem, int index)
    {
        insertObject(newItem, index);
    }

    /**
        Inserts all of the StoredItem items in the specified
        list into this list in order, at the specified index.

        @param list the list of StoredItem items to insert into
        this list
        @param index the index at which to insert the StoredItem
        items
    */
    public void insertAll(StoredItemList list, int index)
    {
    ...
    */
    public void set(int index, StoredItem newItem)
    {
    ...
    /**
        Removes from this list the first StoredItem in it
        that is equal to 'item', where items are compared using 'item''s
        equals() method.

        @param item the StoredItem to remove
    ...
    */
    public StoredItem[] toArray()
    {
        StoredItem[] array =
            new StoredItem[size()];
        return (StoredItem[]) toObjectArray(array);
    }
    ...
    */
    private static void appendItems(StoredItemList src, StoredItemList dest)
    {
        Assert.require(src != null);
        Assert.require(dest != null);

        StoredItemIterator iter = src.iterator();
        while (iter.hasNext())
        {
            dest.add(iter.next());
        }
    ...
    */
    public abstract StoredItemList cloneList();
        // Assert.ensure(result != null);
    ...
    */
    public abstract StoredItemList subList(int startIndex);
        // Assert.ensure(result != null);
    ...
    /**
        ...
        @return the sublist of this list
    */
    public abstract StoredItemList
    ...
    /**
        An array-backed StoredItemList.
    */
    private static class ArrayTypedList
        extends StoredItemList
    {
        // Constructors
        ...
        */
        ...
        /**
            @see StoredItemList#cloneList
        */
        public StoredItemList cloneList()
        {
            StoredItemList result = new ArrayTypedList(size());
        ...
        /**
            @see StoredItemList#subList(int)
        */
        public StoredItemList subList(int startIndex)
        {
            return new ArrayTypedList(subBackingList(startIndex));
        }

        /**
            @see StoredItemList#subList(int, int)
        */
        public StoredItemList
            subList(int startIndex, int pastEndIndex)
        {
    ...
    /**
        An unmodifiable single-item list-backed StoredItemList.
    */
        ...
        extends StoredItemList
    {
        ...
        */
        public SingleItemTypedList(StoredItem item)
        {
        ...
        */
        public StoredItemList cloneList()
        {
            StoredItemList result = new SingleItemTypedList(get(0));
    ...
    /**
        A linked list-backed StoredItemList.
    */
        ...
        extends StoredItemList
    {
        ...
        */
        public StoredItemList cloneList()
        {
            StoredItemList result = new LinkedTypedList();
    ...
    /**
        Iterates through the StoredItem items in a(n)
        StoredItemList.

        @see StoredItem
        @see StoredItemList
    */
    protected static class BuiltInStoredItemListIterator
        extends TypedListIterator
        implements StoredItemIterator
    {
        // Constructors

        /**
            Constructs a BuiltInStoredItemListIterator from the
            StoredItemList whose StoredItem items it is
            to iterate over.

            @param list the StoredItemList that the
            iterator is to iterate over the elements of
        */
        public BuiltInStoredItemListIterator(StoredItemList list)
        {
            super(list);
        }
        ...
        /**
            @see StoredItemIterator#next
        */
        public StoredItem next()
        {
            return (StoredItem) nextObject();
        }

        /**
            @see StoredItemIterator#peek
        */
        public StoredItem peek()
        {
            return (StoredItem) peekObject();
        }
    }
}
...
*/
class StoredItemArrayIterator
    implements StoredItemIterator
{
    // Private fields

    /** The array that we iterate over. */
    private StoredItem[] _array;
    ...
    */
    ...
    /**
        ...
        @param arr the array
    */
    public StoredItemArrayIterator(StoredItem[] arr)
    {
    ...
    /**
        @see StoredItemIterator#hasNext
    */
