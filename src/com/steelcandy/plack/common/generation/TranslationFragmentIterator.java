...
/**
    The interface implemented by all iterators over TranslationFragment
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/generation/TranslationFragmentIterator.java
    </ul>

    @author James MacKay
    @see TranslationFragment
*/
public interface TranslationFragmentIterator
{
    // Public methods
    ...
    */
    ...
    /**
        @return the next TranslationFragment
    ...
    */
    ...
    /**
        ...
        @return the next TranslationFragment without consuming it
