...
/**
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/semantic/UnarySymbolTableEntryPredicate.java
    </ul>

    @author James MacKay
    @see SymbolTableEntry
*/
public interface UnarySymbolTableEntryPredicate
{
    /**
        Indicates whether the specified SymbolTableEntry satisfies this
        predicate.

        @param item the SymbolTableEntry to test
        @return true iff the SymbolTableEntry satisfies this predicate
    */
