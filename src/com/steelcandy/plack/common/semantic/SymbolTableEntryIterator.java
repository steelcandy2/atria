...
/**
    The interface implemented by all iterators over SymbolTableEntry
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/semantic/SymbolTableEntryIterator.java
    </ul>

    @author James MacKay
    @see SymbolTableEntry
*/
public interface SymbolTableEntryIterator
{
    // Public methods
    ...
    */
    ...
    /**
        @return the next SymbolTableEntry
    ...
    */
    ...
    /**
        ...
        @return the next SymbolTableEntry without consuming it
