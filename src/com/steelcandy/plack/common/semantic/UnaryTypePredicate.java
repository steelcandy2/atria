...
/**
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/common/semantic/UnaryTypePredicate.java
    </ul>

    @author James MacKay
    @see Type
*/
public interface UnaryTypePredicate
{
    /**
        Indicates whether the specified Type satisfies this
        predicate.

        @param item the Type to test
        @return true iff the Type satisfies this predicate
    */
    public boolean isSatisfied(Type item);
}
