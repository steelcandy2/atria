...
/**
    The class of exception thrown when an attempt is made to add
    ...
    extends PlackException
{
    ...
    /**
        Constructs an InvalidSymbolTableEntryException.
    */
    public InvalidSymbolTableEntryException()
    {
        // empty
    }
    ...
    */
    public InvalidSymbolTableEntryException(String msg)
    {
        super(msg);
    }
    ...
    */
    public InvalidSymbolTableEntryException(Throwable ex)
    {
        super(ex);
    }

    /**
        Constructs an InvalidSymbolTableEntryException from a message
        ...
        exception
    */
    public InvalidSymbolTableEntryException(String msg, Throwable ex)
    {
        super(msg, ex);
    }
}
