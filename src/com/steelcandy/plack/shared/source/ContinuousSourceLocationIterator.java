...
/**
    The interface implemented by all iterators over ContinuousSourceLocation
    items.
    <p>
    ...
    <ul>
        ...
        <li>Output: src/com/steelcandy/plack/shared/source/ContinuousSourceLocationIterator.java
    </ul>

    @author James MacKay
    @see ContinuousSourceLocation
*/
public interface ContinuousSourceLocationIterator
{
    // Public methods

    /**
        @return true iff this iterator will return at least one more
        ContinuousSourceLocation
    */
    public boolean hasNext();

    /**
        @return the next ContinuousSourceLocation
        @exception NoSuchItemException thrown iff there isn't a next
        ContinuousSourceLocation
        @see #peek
    */
    public ContinuousSourceLocation next()
    ...
    /**
        ...
        @return the next ContinuousSourceLocation without consuming it
        ...
        @see #next
    */
    public ContinuousSourceLocation peek()
        throws NoSuchItemException;
}
